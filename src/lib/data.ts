...
export const offers: Offer[] = [
  {
    ...
    detail: "Verified by Forever: reserve any villa this quarter and the full designer furniture package is included at handover.",
  ...
  },
  {
    ...
    detail: "Developer covers the 2% transfer fee on any 2-bedroom unit reserved before end of quarter. Verified by Forever.",
    expires: "August 15",
  ...
  },
  {
    ...
    detail: "Independently verified pre-launch discount held for the first twelve buyers in this ridge release.",
    expires: "July 20",
    savings: "Save ฿3.1M",
  },
  {
    ...
    detail: "Complimentary first-year rental management with owner-friendly terms. Verified against the signed contract.",
    expires: "October 1",
