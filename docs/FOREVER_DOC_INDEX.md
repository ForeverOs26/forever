...
| `docs/STRUCTURED_INPUT_PREPARATION_DESIGN_V1.md` | Structured Input Preparation design v1: evidence-backed boundary, input/output contracts, first implementation slice, human review model, anti-fabrication policy, architecture comparison, acceptance criteria, and roadmap. Design only; awaiting review. | Conditional         |
