...
| `docs/SIP_001B_CORALINA_20260717_REPORT.md`      | SIP-001B independent-review report for the versioned Coralina 2026-07-17 text-PDF validation and Master Plan registration; not canonical until Owner merge.                                                                                       | Conditional         |
