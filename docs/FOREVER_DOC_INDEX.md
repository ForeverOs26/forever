...
| `docs/SIP_001A_IMPLEMENTATION_REPORT.md`         | SIP-001A implementation report: narrow local text-PDF price-list extraction modules, safe-fixture test evidence, real-Rainpalm-pilot preflight result, and the exact external prerequisite that currently blocks a real Rainpalm run. Independent-review record; not a canonicalization of SIP-001A. | Conditional         |
