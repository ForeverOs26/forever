...
`docs/FOREVER_STRATEGIC_NORTH_STAR.md` is mandatory pre-task reading and governs product priority and commercial sequencing; a proposed task must reconcile with it before selection.
...
| `docs/FOREVER_STRATEGIC_REVIEW_SOURCE_2026_07_20.md` | Durable identity and authority record for the privately retained independent strategic report, including exact filename, size, SHA-256, accepted findings, corrections, and re-access rule.                                                       | Conditional         |
...
| `docs/FOREVER_STUDIO_001_IMPLEMENTATION_REPORT.md`   | FOREVER-STUDIO-001 implementation report: selected architecture, server boundary, migration draft, validation evidence, remaining Owner/Codex/Supabase work, risks. Implementation lives in an open, unmerged draft PR pending independent review. | Conditional         |
| `docs/FOREVER_STUDIO_OWNER_RUNBOOK.md`               | Owner runbook for Forever Studio: one-time setup, daily publishing flows, later enrichment, publisher invitations, and recovery.                                                                                                                   | Conditional         |
...
| `docs/SIP_001B_CORALINA_20260717_REPORT.md`          | Canonical SIP-001B independent-review record for the versioned Coralina 2026-07-17 text-PDF validation and Master Plan registration.                                                                                                              | Conditional         |
...
| `docs/FOREVER_TRUTH_001A_PUBLIC_TRUTH_AUDIT.md`      | FOREVER-TRUTH-001A public truth audit record: repository-proven defects, the fail-closed policy and corrections, regression protection, production unknowns, and remaining Owner/Codex work.                                                       | Conditional         |
...
| `docs/FOREVER_CRM_ARCHITECTURE_V1.md`                | FOREVER-CRM-ARCH-001 proposed target CRM architecture: product boundary, roles, journeys, state machines, domain model and ERD, integration and event design, automation catalogue, KPI model, RBAC/security, privacy and consent, ADRs, "Do Not Build Yet", and the recommended first vertical slice. Proposal only — authorizes no implementation. | Conditional         |
| `docs/FOREVER_CRM_CURRENT_STATE_AUDIT.md`            | FOREVER-CRM-ARCH-001 read-only repository audit of the current lead/CRM surface at main `821b3c4e`, with the reuse map (reuse as-is / extend / migrate / deprecate / do not build) and an explicit list of what could not be verified.             | Conditional         |
| `docs/FOREVER_CRM_MARKET_RESEARCH.md`                | FOREVER-CRM-ARCH-001 2026 research base: general and real-estate CRM patterns, the speed-to-lead evidence review, Thai PDPA, WhatsApp Business Platform, and Supabase/identity-resolution engineering, with sources. Architecture research, not legal advice. | No                  |
| `docs/FOREVER_CRM_IMPLEMENTATION_PLAN.md`            | FOREVER-CRM-ARCH-001 build-versus-integrate decision, phased roadmap, decomposed backlog with acceptance criteria, migration and compatibility strategy, risk register, and the Owner Decision Register.                                          | Conditional         |
| `docs/FOREVER_CRM_INDEPENDENT_REVIEW.md`             | FOREVER-CRM-ARCH-001 independent adversarial review across eleven perspectives, the architect's reconciliation of the findings, and the final recommendation on what Forever should build first.                                                  | Conditional         |
| `docs/FOREVER_CRM_EXECUTIVE_SUMMARY_RU.md`           | FOREVER-CRM-ARCH-001 Russian-language executive summary for the Owner: what the CRM becomes, who it helps, the first version, what must not be built yet, the main risks, and the decisions that still require the Owner.                         | Conditional         |
